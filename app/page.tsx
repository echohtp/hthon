...
const faqs = [
  {
    question: "Do I need to register first before submitting a project?",
    answer:
      "",
  },
  {
    ...
    <>
      ...
      <div className="relative h-screen overflow-hidden bg-indigo-900">
            ...
            <div className="items-center justify-center md:flex">
              ...
              <div className="items-center hidden md:flex bg-gray-800 bg-opacity-65 rounded-full my-4 py-4 px-8">
                <a
                  ...
                  className="mx-3 text-lg text-gray-300 uppercase cursor-pointer hover:text-white"
                >
                  Resources
                </a>
                <a className="mx-3 text-lg text-gray-300 uppercase cursor-pointer hover:text-white">
                  Register Now
                </a>
                <a className="mx-3 text-lg text-gray-300 uppercase cursor-pointer hover:text-white">
                  F.A.Q.
        ...
        <div className="container h-screen relative z-10 flex items-center px-6 py-32 mx-auto md:px-12 xl:py-40">
          <div className="relative z-10 flex flex-col items-center w-full align-middle">
            ...
            <a
              href="#"
              className="block px-4 py-3 mt-10 text-lg font-bold text-white uppercase rounded-lg  bg-gray-800 hover:bg-gray-900 register-button"
            >
              Register Now
            </a>
          </div>
      ...
      <div className="relative  overflow-hidden bg-indigo-900">
        <div className="image-container">
          ...
          />
          <div className="absolute inset-x-0 bottom-0 h-full bg-gradient-to-t h-1/2 from-transparent to-black">
            <h1>something</h1>
          </div>
        </div>
      </div>
